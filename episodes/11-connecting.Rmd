...
```{r, echo=FALSE}
snippets('cluster/secure-connections-info.Rmd')
```
...
reference to its parent (``r config$remote$fs$home``). You may or may not see
...
snippets('cluster/authorized-keys-info.Rmd')
```
