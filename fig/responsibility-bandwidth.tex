...
\begin{document}
    \begin{tikzpicture}
        ...
        \node[disk,anchor=north]    (disk 1)     at ($(raid.south)+(-1in, -3cm)$) {\begin{minipage}{2.7cm}
                                                                                   ...
                                                                                   \end{minipage}
                                                                                   \begin{minipage}{1cm}
                                                                                       \includegraphics[height=\textwidth,angle=90,origin=c]{maze-medium}
                                                                                   \end{minipage}};
        \node[disk]                 (disk 2)     at ($(disk 1) + (2cm, 0)$)       {\begin{minipage}{2.7cm}
                                                                                   ...
                                                                                   \end{minipage}
                                                                                   \begin{minipage}{1cm}
                                                                                       \includegraphics[height=\textwidth,angle=270,origin=c]{maze-medium}
                                                                                   \end{minipage}};
        ...
        \node[disk]                 (disk N)     at ($(dots) + (+1.5cm, 0)$)      {\begin{minipage}{2.7cm}
                                                                                   ...
                                                                                   \end{minipage}
                                                                                   \begin{minipage}{1cm}
                                                                                       \includegraphics[height=\textwidth,angle=90,origin=c]{maze-medium-mirror}
                                                                                   \end{minipage}};
        \node[network]              (nic)        [right=of raid]                  {\begin{minipage}{2.7cm}
                                                                                   ...
                                                                                   \end{minipage}
                                                                                   \begin{minipage}{1cm}
                                                                                       \includegraphics[height=\textwidth,angle=90,origin=c]{maze-small}
                                                                                   \end{minipage}};
