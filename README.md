...
[![Build Status](https://travis-ci.com/hpc-carpentry/hpc-intro.svg?branch=gh-pages)](
https://travis-ci.com/hpc-carpentry/hpc-intro)
...
1. **Please _do not fork this repository directly on GitHub._** Instead, please use GitHub's
   ...
   `workshop-template` repository and customize it for your workshop.
    ...
    - Follow the instructions found in the [Software Carpentry example lesson source](https://github.com/carpentries/lesson-example/)
      to create a repository for your lesson.
    - Edit [_config.yml](_config.yml) to modify the configuration options for the HPC system you
